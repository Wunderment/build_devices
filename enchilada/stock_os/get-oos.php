...
$string = file_get_contents( 'oneplus-6.json' );
...
$last_filename = '/home/WundermentOS/devices/enchilada/stock_os/last.stock.os.release.txt';
...
if( $current_release[ 'versionReleaseTime' ] !== $last_release ) {
	...
	$cmd = 'wget -O ~/devices/enchilada/stock_os/current-stock-os.zip ' . escapeshellarg( $current_release[ 'versionLink' ] );
