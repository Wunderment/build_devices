...
function build_wos {
	...
	BCCFILE=~/android/lineage-$LOS_BUILD_VERSION/device/$VENDOR/gs201/BoardConfig-common.mk
	...
	BCLFILE=~/android/lineage-$LOS_BUILD_VERSION/device/$VENDOR/gs201/BoardConfigLineage.mk
