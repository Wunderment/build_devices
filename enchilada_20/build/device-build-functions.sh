...
function build_wos {
	...
	BCCFILE=~/android/lineage-$LOS_BUILD_VERSION/device/$VENDOR/$COMMONDEVICE/BoardConfigCommon.mk
	...
	CFILE=~/android/lineage-$LOS_BUILD_VERSION/device/$VENDOR/$COMMONDEVICE/common.mk
	...
	IRQFILE=~/android/lineage-$LOS_BUILD_VERSION/device/$VENDOR/$COMMONDEVICE/rootdir/etc/init.recovery.qcom.rc
	...
	IQFILE=~/android/lineage-$LOS_BUILD_VERSION/device/$VENDOR/$COMMONDEVICE/rootdir/etc/init.qcom.rc
