...
$last_filename = '/home/WundermentOS/devices/dumpling_17/stock_os/last.stock.os.release.txt';
...
if( $current_release[ 'versionReleaseTime' ] !== $last_release ) {
	...
	$cmd = 'wget -O ~/devices/dumpling_17/stock_os/current-stock-os.zip ' . escapeshellarg( $current_release[ 'versionLink' ] );
